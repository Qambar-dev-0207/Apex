...
class TestGeminiTechnique(unittest.TestCase):
    ...
    async def verify_grep_search(self):
    ...
    async def verify_find_glob(self):
    ...
    def test_all(self):
        ...
        try:
            loop.run_until_complete(self.verify_grep_search())
            loop.run_until_complete(self.verify_find_glob())
        finally:
            loop.close()
